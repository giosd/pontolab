...
import type { ReportActivityHours } from "@/types";

interface ActivityHoursTableProps {
  rows: ReportActivityHours[];
}

export function ActivityHoursTable({ rows }: ActivityHoursTableProps) {
  return (
